...
// eslint-disable-next-line max-len
const testUri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@clusterfree.neutu.mongodb.net/TestDB?retryWrites=true&w=majority`;

module.exports = {
  mongodb: {
    // TODO: need to add separate independent test environment
    uri: process.env.NODE_ENV === 'test' ? testUri : mongoUri,
  },
};
